...
## Disclaimer
**This only works with GNOME and Cinnamon**. 

Tested on: 
- Fedora 36 with GNOME 42 and Cinnamon
- Fedora 40 with GNOME 46
- Fedora 41 with GNOME 47

it might not work with older/newer versions, albeit profiles already generated should continue to work.
